...
public:
    ...
    const int MAX_LOOP_FOR_PUT = 500;
...
{
    {
        // OptCuckoo<int> Cuckoo(5 * 100 * 1000);
        // for (int i = 0; i < 1 * 1000 * 1000; i++)
        // {
        //     Cuckoo.put("random:" + to_string(i), i,1);
        // }
        // for (int i = 0; i < 1 * 1000 * 1000; i++)
        // {
        //     cout << Cuckoo.get("random:" + to_string(i)) << endl;
        // }
    }
    // {
    //     unordered_map<string, int> ref_map;
    //     const int ops = 1 * 1000 * 1000;
